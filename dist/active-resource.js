/*
	active-resource 1.0.0-beta.8-unreleased
	(c) 2022 Nick Landgrebe && Peak Labs, LLC DBA Occasion App
...
(function (global, factory) {
  ...
  var activeResource = ActiveResource = /*#__PURE__*/_createClass(function ActiveResource() {
  ...
  (function () {
    ...
    ActiveResource.Interfaces = ActiveResource.prototype.Interfaces = function () {
      var Interfaces = /*#__PURE__*/_createClass(function Interfaces() {
      ...
      var JsonApi = /*#__PURE__*/function (_ActiveResource$proto) {
        ...
        _createClass(JsonApi, [{
          ...
          value: function buildResource(data, includes, _ref2) {
            ...
            attributes = this.addRelationshipsToFields(attributes, relationships, includes, primaryData, resource, resourceRegister);
          ...
          value: function addRelationshipsToFields(attributes, relationships, includes, primaryData, resource, resourceRegister) {
            var _this8 = this;
              ...
              if (reflection = resource.klass().reflectOnAssociation(s.camelize(relationshipName))) {
                if (reflection.collection()) {
                  relationshipItems = ActiveResource.prototype.Collection.build(relationship['data']).map(function (relationshipMember, index) {
                    ...
                    return cachedResource || _this8.findResourceForRelationship(relationshipMember, includes, primaryData, resource, reflection, resourceRegister, index);
                  }).compact();
                  ...
                  include = cachedResource || _this8.findResourceForRelationship(relationship['data'], includes, primaryData, resource, reflection, resourceRegister);
                  if (include != null) {
          ...
          value: function findResourceForRelationship(relationshipData, includes, primaryData, resource, reflection, resourceRegister, index) {
  ...
  (function () {
    ...
    ActiveResource.prototype.Associations.prototype.Builder = function () {
      var Builder = /*#__PURE__*/_createClass(function Builder() {
      ...
      Builder.prototype.Association = /*#__PURE__*/function () {
        ...
        _createClass(Association, null, [{
          ...
          function build(model, name, options) {
            var reflection;
  ...
  (function () {
    ActiveResource.prototype.Associations.prototype.Builder.prototype.CollectionAssociation = /*#__PURE__*/function (_ActiveResource$proto10) {
      ...
      return _createClass(CollectionAssociation);
  ...
  (function () {
    ActiveResource.prototype.Associations.prototype.Builder.prototype.SingularAssociation = /*#__PURE__*/function (_ActiveResource$proto12) {
      ...
      _createClass(SingularAssociation, null, [{
        ...
        // @param [Class] model the ActiveResource class to apply the association to
        // @param [Reflection] reflection the reflection of the association to build accessors for
        function defineAccessors(model, reflection) {
  ...
  (function () {
    ActiveResource.prototype.Immutable = /*#__PURE__*/_createClass(function Immutable() {
  ...
  (function () {
    ...
    ActiveResource.prototype.Immutable.prototype.Persistence = /*#__PURE__*/function () {
      ...
      _createClass(Persistence, null, [{
        ...
        // @param [Function] callback the callback to pass the ActiveResource into
        // @return [Promise] a promise to return the ActiveResource, valid or invalid
        function update(attributes, callback) {
          var attributesKeys, oldAttributes;
          attributesKeys = ActiveResource.prototype.Collection.build(_.keys(attributes));
          oldAttributes = _.pick(this.attributes(), attributesKeys.toArray());
          oldAttributes = _.defaults(oldAttributes, attributesKeys.inject({}, function (obj, k) {
